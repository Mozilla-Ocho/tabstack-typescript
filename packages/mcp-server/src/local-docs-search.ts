...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "response": "object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object | object",
  ...
  },
  {
    ...
    "description": "Submit a response to an interactive form data request from an in-progress automation task. When the AI agent encounters a form requiring user data, it emits an `interactive:form_data:request` or `interactive:form_data:error` SSE event containing a `requestId`. Use this endpoint to provide the requested data or cancel the request.\n\n**Lifecycle:**\n- Input requests expire after 2 minutes by default\n- Expired or already-answered requests return `410 Gone`\n- Successful submissions return `202 Accepted` (fire-and-forget from caller's perspective)",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tabstack.ai/v1/automate/$REQUEST_ID/input \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $TABSTACK_API_KEY\" \\\n    -d '{}'"
      }
    }
  },
  {
    ...
    "response": "{ data: object; event: 'analyzing:end'; } | { data: object; event: 'analyzing:start'; } | { data: object; event: 'complete'; } | { data: object; event: 'error'; } | { data: object; event: 'evaluating:end'; } | { data: object; event: 'evaluating:start'; } | { data: object; event: 'following:end'; } | { data: object; event: 'following:start'; } | { data: object; event: 'iteration:end'; } | { data: object; event: 'iteration:start'; } | { data: object; event: 'judging:end'; } | { data: object; event: 'judging:start'; } | { data: object; event: 'outlining:end'; } | { data: object; event: 'outlining:start'; } | { data: object; event: 'planning:end'; } | { data: object; event: 'planning:start'; } | { data: object; event: 'prefetching:end'; } | { data: object; event: 'prefetching:start'; } | { data: object; event: 'searching:end'; } | { data: object; event: 'searching:start'; } | { data: object; event: 'start'; } | { data: object; event: 'writing:end'; } | { data: object; event: 'writing:start'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tabstack.ai/v1/research \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $TABSTACK_API_KEY\" \\\n    -d '{\n          \"query\": \"What are the latest developments in quantum computing?\",\n          \"fetch_timeout\": 30,\n          \"mode\": \"fast\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tabstack.ai/v1/extract/json \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $TABSTACK_API_KEY\" \\\n    -d '{\n          \"json_schema\": {\n            \"properties\": {\n              \"stories\": {\n                \"items\": {\n                  \"properties\": {\n                    \"author\": {\n                      \"description\": \"Author username\",\n                      \"type\": \"string\"\n                    },\n                    \"points\": {\n                      \"description\": \"Story points\",\n                      \"type\": \"number\"\n                    },\n                    \"title\": {\n                      \"description\": \"Story title\",\n                      \"type\": \"string\"\n                    }\n                  },\n                  \"type\": \"object\"\n                },\n                \"type\": \"array\"\n              }\n            },\n            \"type\": \"object\"\n          },\n          \"url\": \"https://news.ycombinator.com\",\n          \"effort\": \"standard\"\n        }'"
      }
    }
  },
  {
    ...
    "httpMethod": "post",
    "summary": "Markdown",
    "description": "Fetches a URL and converts its HTML content to clean Markdown format with optional metadata extraction",
    ...
    "response": "{ content: string; url: string; metadata?: { author?: string; created_at?: string; creator?: string; description?: string; image?: string; keywords?: string[]; modified_at?: string; page_count?: number; pdf_version?: string; producer?: string; publisher?: string; site_name?: string; subject?: string; title?: string; type?: string; url?: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tabstack.ai/v1/extract/markdown \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $TABSTACK_API_KEY\" \\\n    -d '{\n          \"url\": \"https://example.com/blog/article\",\n          \"effort\": \"standard\",\n          \"metadata\": true\n        }'"
      }
    }
  },
  {
    ...
    "httpMethod": "post",
    "summary": "JSON",
    "description": "Fetches URL content, extracts data, and transforms it using AI based on custom instructions. Use this to generate new content, summaries, or restructured data.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.tabstack.ai/v1/generate/json \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $TABSTACK_API_KEY\" \\\n    -d \"{\n          \\\"instructions\\\": \\\"For each story, categorize it (tech/business/science/other) and write a one-sentence summary explaining what it's about in simple terms.\\\",\n          \\\"json_schema\\\": {\n            \\\"properties\\\": {\n              \\\"summaries\\\": {\n                \\\"items\\\": {\n                  \\\"properties\\\": {\n                    \\\"category\\\": {\n                      \\\"description\\\": \\\"Story category (tech/business/science/etc)\\\",\n                      \\\"type\\\": \\\"string\\\"\n                    },\n                    \\\"summary\\\": {\n                      \\\"description\\\": \\\"One-sentence summary of the story\\\",\n                      \\\"type\\\": \\\"string\\\"\n                    },\n                    \\\"title\\\": {\n                      \\\"description\\\": \\\"Story title\\\",\n                      \\\"type\\\": \\\"string\\\"\n                    }\n                  },\n                  \\\"type\\\": \\\"object\\\"\n                },\n                \\\"type\\\": \\\"array\\\"\n              }\n            },\n            \\\"type\\\": \\\"object\\\"\n          },\n          \\\"url\\\": \\\"https://news.ycombinator.com\\\",\n          \\\"effort\\\": \\\"standard\\\"\n        }\""
      }
    }
  }
];
